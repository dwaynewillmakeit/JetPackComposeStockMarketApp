...
import com.dwaynewillmakeit.stockmarketapp.data.csv.IntradayInfoParser
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindIntradayInfoParse(intradayInfoParser: IntradayInfoParser): CSVParser<IntradayInfo>
